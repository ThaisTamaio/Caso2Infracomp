...
public class Matriz {
    ...
    private int tamanioBytes; // Tamaño en bytes de la matriz
    
    public Matriz(int nf, int nc, int te) { // Constructor de la clase Matriz
        this.nf = nf;
        this.nc = nc;
        this.te = te;
        this.tamanioBytes = nf * nc * te; // Tamaño en bytes de la matriz
    ...
    public void setTamanioBytes(int tamanioBytes) { // Setter para el tamaño en bytes de la matriz
        this.tamanioBytes = tamanioBytes;
    }

    public int getTamanioBytes() { // Getter para el tamaño en bytes de la matriz
        return tamanioBytes;
    }

    public int getNf() { // Getter para el número de filas de la matriz
        return nf;
    }

    public int getNc() { // Getter para el número de filas de la matriz
        return nc;
    }

    public int getTe() { // Getter para el número de filas de la matriz
        return te;
    }
